...
%   This is done for an external input trajectory (namely Set-point
%   variation), taking pulses uniformly distributed between 5 and 15
%   minutes and amplitudes between 0.25 and 0.95
%  ========================================================================
function main_experiments(Method,hour,n_app,bSame);
...
Amplitudes.eta_pos_low =        0.25;
Amplitudes.eta_pos_high =       0.35;
Amplitudes.eta_neg_low =        -0.25;
Amplitudes.eta_neg_high =       -0.35;
...
while(count < 7)
    ...
    tests_ext_controller_OL_hourly(Method,hour,input_type,N_E,...
        bDifferentFiles,Amplitudes,NAnalysis,n_app,bSame);
